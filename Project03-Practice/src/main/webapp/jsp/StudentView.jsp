			...
			<div class="col-md-6">
				<div class="card input-group-addon">
					<div class="card-body">
						...
						<!-- Student First Name-->
 							<label><b>Student First Name</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								...
 								<input type="text" class="form-control" name="firstName" placeholder="Student First Name" 
 								value="<%=DataUtility.getStringData(dto.getFirstName())%>">
 								</div>
 								<font color="red"><%=ServletUtility.getErrorMessage("firstName", request)%></font><br>
						
						<!-- Student Last Name-->
 							<label><b>Student Last Name</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text" id="basic-addon1"><i class="fa fa-user-alt" style="font-size: 25px;"></i></span>
 								...
 								<input type="text" class="form-control" name="lastName" placeholder="Student Last Name" 
						...
						<!-- Student Mobile Number -->
 							<label><b>Student Mobile Number</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 								...
 								<input type="text" class="form-control" name="mobileNo"
 									 placeholder="Student Mobile Number" value="<%=DataUtility.getStringData(dto.getMobileNo())%>">
 								</div>
 								<font color="red"><%=ServletUtility.getErrorMessage("mobileNo", request)%></font><br>	 
 														 
 							
							<!--Student Email -->
 							<label><b>Student Email</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
							...
							<!--Student Gender -->
 							<label><b>Student Gender</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
							...
							<!--Student College -->
 							<label><b>Student College</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
						...
						<div class="text-center">
							<input type="submit" class="btn btn-success" name="operation" value="<%=StudentCtl.OP_SAVE%>" >						
                    ...
                    %>
                                ...
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=StudentCtl.OP_CANCEL%>"><br>  								                          
                            </div> 							
                    ...
                    %>
                                ...
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=StudentCtl.OP_RESET%>"><br>  								                          
                            </div> 							
