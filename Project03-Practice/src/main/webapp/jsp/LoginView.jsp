				...
				<div class="card-body">
					...
					<!-- Static Success Message -->
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" name="login" placeholder="Login Id" value="<%=DataUtility.getStringData(dto.getLogin())%>">
						</div>	
						<%=ServletUtility.getErrorMessage("login", request)%><br>
 						
 						<!-- Password -->
 						<label><b>Password</b><span style="color:red">*</span></label>
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1"><i class="fa fa-key style="font-size: 25px;"></i></span>
							</div>	
							<input type="text" class="form-control" name="password" placeholder="Password" value="<%=DataUtility.getStringData(dto.getPassword())%>">
						</div>	
						<%=ServletUtility.getErrorMessage("password", request)%><br>
 						
 						<!-- BUTTONS -->
                            <div class="text-center">
                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=LoginCtl.OP_SIGN_IN%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=LoginCtl.OP_SIGN_UP%>"><br>
