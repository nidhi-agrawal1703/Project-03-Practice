			...
			<div class="col-md-6">
				<div class="card input-group-addon">
					<div class="card-body">
						...
						<!-- College Name-->
 							<label><b>College Name</b><span style="color:red">*</span></label>
						...
						<!-- College Address -->
 							<label><b>College Address</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
							...
							<!--College City -->
 							<label><b>College City</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text" id="basic-addon1"><i class="fa fa-list" style="font-size: 25px;"></i></span>
 									
 								</div>
 								<input type="text" class="form-control" name="city" placeholder="College City"
 								value="<%=DataUtility.getStringData(dto.getCity())%>">
 								</div>
 								<font color="red"><%=ServletUtility.getErrorMessage("city", request)%></font><br> 
 							
							<!--College State -->
 							<label><b>College State</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text" id="basic-addon1"><i class="fa fa-list" style="font-size: 25px;"></i></span>
 									
 								</div>
 								<input type="text" class="form-control" name="state" placeholder="College State"
 								value="<%=DataUtility.getStringData(dto.getState())%>">
 								</div>
 								<font color="red"><%=ServletUtility.getErrorMessage("state", request)%></font><br> 
 								
 								<!--College Phone No -->
 							<label><b>College Phone No</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text" id="basic-addon1"><i class="fa fa-list" style="font-size: 25px;"></i></span>
 									
 								</div>
 								<input type="text" class="form-control" name="phoneNo" placeholder="College Phone No"
						...
						<div class="text-center">
							<input type="submit" class="btn btn-success" name="operation" value="<%=CollegeCtl.OP_SAVE%>" >						
                    ...
                    %>
                                ...
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=CollegeCtl.OP_CANCEL%>"><br>  								                          
                            </div> 							
                    ...
                    %>
                                ...
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=CollegeCtl.OP_RESET%>"><br>  								                          
                            </div> 							
