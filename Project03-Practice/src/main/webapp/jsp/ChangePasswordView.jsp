					...
					<h3 class="text-center text-primary pb-3">Change Password</h3>
            			...
            			<!-- Old Password -->
 							...
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text"><i class="fa fa-key" style="font-size: 25px;"></i></span>
 								</div>
 								<input type="text" class="form-control" name="oldPassword" placeholder="Old Password"
 								value="<%=dto.getPassword()%>" readonly="readonly">
 						...
 						<!-- New Password -->
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="newPassword" placeholder="New Password" value="<%=DataUtility.getString(request.getParameter("newPassword") == null ? "" : DataUtility.getString(request.getParameter("newPassword"))) %>">
							</div>
							<%=ServletUtility.getErrorMessage("newPassword",request) %><br>							
						...
						<label>Confirm Password<span style="color:red;">*</span></label>
							<div class="input-group">
								...
								<input type="text" class="form-control" name="confirmPassword" placeholder="Confirm Password" value="<%=DataUtility.getString(request.getParameter("confirmPassword") == null ? "" : DataUtility.getString(request.getParameter("confirmPassword"))) %>">
							</div>
							<%=ServletUtility.getErrorMessage("confirmPassword",request) %><br>		
