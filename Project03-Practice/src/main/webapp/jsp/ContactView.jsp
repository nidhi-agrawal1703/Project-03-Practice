...
<!-- Bean Tag -->
	<jsp:useBean id="dto" class="in.co.rays.proj3.dto.ContactDTO" scope="request"></jsp:useBean>
				...
				<div class="card input-group-addon">
					<div class="card-body">
						<%
							...
							if(dto.getId()!=null){						
						%>				
						<h3 class="text-center text-primary pb-3">Update Contact</h3>
						<%}else { %>
						<h3 class="text-center text-primary pb-3">Add Contact</h3>
						<%} %>
						...
						<!-- Contact Name -->
 							<label><b>Contact Name</b><span style="color:red">*</span></label>
 						...
 						<!-- Contact Email -->
 							<label><b>Contact Email</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
							...
							<!--Contact Mobile No -->
 							<label><b>Contact Mobile No</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
							...
							<!-- Contact Message-->
 							<label><b>Contact Message</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text" id="basic-addon1"><i class="fa fa-clock" style="font-size: 25px;"></i></span>
						...
						<div class="text-center">
							<input type="submit" class="btn btn-success" name="operation" value="<%=ContactCtl.OP_SAVE%>" >						
						
						<%
                        if (dto.getId() !=null) {
                    %>
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=ContactCtl.OP_CANCEL%>"><br>  								                          
                            </div> 							
                    ...
                    %>
                                ...
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=ContactCtl.OP_RESET%>"><br>  								                          
                            </div> 							
