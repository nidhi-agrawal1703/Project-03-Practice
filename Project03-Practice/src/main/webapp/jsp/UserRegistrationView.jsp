				...
				<div class="card-body">
					<h3 class="text-center text-primary pb-3">User Registration</h3>
						...
						<label><b>Login Id</b><span style ="color:red">*</span></label>
							...
							<input type="text" class="form-control" name="login" placeholder="Login" value="<%=DataUtility.getStringData(dto.getLogin()) %>"/>
							</div>
						...
						<label><b>Confirm Password</b><span style ="color:red">*</span></label>
							...
							<input type="password" class="form-control" name="confirmPassword" placeholder="Password" value="<%=DataUtility.getStringData(dto.getConfirmPassword()) %>"/>
							</div>
						...
						%> <%=htmlList%>
 						...
 						<!-- BUTTONS -->
                            <div class="text-center">
                                ...
                                <input type="submit" class="btn btn-success" name="operation" value="<%=UserRegistrationCtl.OP_SIGNUP%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=BaseCtl.OP_RESET%>"><br>
